    ...
    def save_image(self, rsp_data, word):
        ...
        for image_info in rsp_data['imgs']:
            ...
            try:
                ...
                # 保存图片
                urllib.request.urlretrieve(image_info['objURL'], './' + word + '/' + 'ak_' + str(self.__counter) + str(suffix))
...
if __name__ == '__main__':
    ...
    crawler.start('ak 枪', 20, 1)  # 抓取关键词为 “二次元 美女”，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
